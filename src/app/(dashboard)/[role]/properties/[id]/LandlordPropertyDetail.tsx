      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
        <section>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' }}>
            ...
            {activeTenant && (
              <Link href={`/messages?user=${activeTenant.id}`}>
          ...
          <Card padding="none">
            <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
              <li style={{ padding: '1rem 1.5rem', borderBottom: '1px solid var(--color-border)', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                ...
                <Link href={`/landlord/applications`}><Button size="sm">Review</Button></Link>
              </li>
              <li style={{ padding: '1rem 1.5rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                ...
                <Link href={`/landlord/maintenance`}><Button size="sm">View</Button></Link>
              </li>
            </ul>
          </Card>
        </section>
