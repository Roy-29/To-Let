    ...
    <div className={styles.container}>
      ...
      <div className={styles.metricsGrid}>
        <Card className={styles.metricCard}>
          ...
          <Link href="/dashboard/properties" className={styles.metricLink}>Manage Properties</Link>
        </Card>
        
        <Card className={styles.metricCard}>
          <h3 className={styles.metricLabel}>Active Tenants</h3>
          <p className={styles.metricValue}>{analytics.activeTenants}</p>
          <Link href="/dashboard/tenants" className={styles.metricLink}>View Tenants</Link>
        </Card>

        <Card className={styles.metricCard}>
          <h3 className={styles.metricLabel}>Pending Applications</h3>
          <p className={styles.metricValue}>{analytics.pendingApplications}</p>
          <Link href="/dashboard/applications" className={styles.metricLink}>Review Applications</Link>
        </Card>
        ...
        <Card className={styles.metricCard}>
          ...
          <Link href="/dashboard/maintenance" className={styles.metricLink}>View Maintenance</Link>
        </Card>
      </div>
      ...
      <div className={styles.sectionsGrid}>
        <section className={styles.section}>
          <div className={styles.sectionHeader}>
            ...
            <Link href="/dashboard/rent"><Button variant="ghost" size="sm">Manage Rent</Button></Link>
          </div>
          <Card padding="none">
