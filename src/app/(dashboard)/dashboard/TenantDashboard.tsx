      ...
      <div className={styles.sectionsGrid}>
        <section className={styles.section}>
          <div className={styles.sectionHeader}>
            ...
            <Link href="/dashboard/applications"><Button variant="ghost" size="sm">View All</Button></Link>
          </div>
          <Card padding="none">
        ...
        <section className={styles.section}>
          <div className={styles.sectionHeader}>
            ...
            <Link href="/dashboard/rent"><Button variant="ghost" size="sm">View All</Button></Link>
          </div>
          <Card padding="none">
